...
val batchOut = new java.io.BufferedWriter(
   new java.io.FileWriter ("src/main/scripts/Device-Deactivate-Logging.bat"))
...
forAllDevices {
   Device =>
      ...
      (adb :: "-s" :: Device :: "shell" :: "setprop" :: "debug.assert" :: "0" :: Nil).!

      setLogging (Device , "Main",       "\"\"")
      setLogging (Device , "KrischikLog", "\"\"")
